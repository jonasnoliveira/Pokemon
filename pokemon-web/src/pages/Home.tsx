...
function HomePage() {
  ...
  const search = () => {
    const foundItems = pokemons.filter((item) =>
      item.name.toLowerCase().includes(query.toLowerCase())
    );
    setPokemons(foundItems);
    // const foundId = pokemons.filter((item) =>
    //   item.id.toString().includes(query.toLowerCase())
    // );
    // setPokemons(foundId);
    // const foundTypes = pokemons.filter((item) =>
    //   item.types.map((pokemonType) => {
    //     pokemonType.type.name.toString().includes(query.toLowerCase())
    //   })
    // );
    // setPokemons(foundTypes);
  };
